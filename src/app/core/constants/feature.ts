...
export const testControllerColumns: any[] = [
    ...
    { label: 'Iteration', value: { field: 'iterations', header: 'Iteration', order: 6 } },
    { label: 'Browsers', value: { field: 'browsers', header: 'Browsers', order: 6 } },
    { label: 'Sequence ID', value: { field: 'sequenceID', header: 'Sequence ID', order: 6 } },
    { label: 'Test Type', value: { field: 'testType', header: 'Test Type', order: 6 } },
    { label: 'Jira ID', value: { field: 'jirA_ID', header: 'Jira ID', order: 6 } },
    { label: 'Steps Count', value: { field: 'stepsCount', header: 'Steps Count', order: 6 } },
    { label: 'Test Script Name', value: { field: 'testScriptName', header: 'Test Script Name', order: 6 } },
    { label: 'Test Script Description', value: { field: 'testScriptDescription', header: 'Test Script Description', order: 6 } },
    // { label: 'Is Locked', value: { field: 'isLocked', header: 'Is Locked' } },
    // { label: 'Locked By User', value: { field: 'lockedByUser', header: 'Locked By User' } },
    { label: 'Created On', value: { field: 'createdOn', header: 'Created On' } },
    { label: 'Updated On', value: { field: 'updatedOn', header: 'Updated On' } },
